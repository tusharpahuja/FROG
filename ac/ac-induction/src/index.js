  ...
  exampleData: [
    ...
    },
    {
      ...
      config: {
        ...
        hasDefinition: true,
        definition:
          'A set is correct only in the case that if 2 objects of the set share a property, the third object should also have this property.',
        hasTest: true,
        nbTest: 5,
        properties: [
